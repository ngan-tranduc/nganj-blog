...
using NganjBlog.Core.Domain.Identity;

namespace NganjBlog.Data
{
    public class NganjBlogContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public NganjBlogContext(DbContextOptions options) : base(options)
        {
        }
